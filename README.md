...
| Package                                                                 | What it is                                                                                                                                                                                                                                                               |
| ----------------------------------------------------------------------- | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------ |
| [`@effect-uai/core`](./packages/core)                                   | The primitives: `Loop`, `LanguageModel`, `Tool`, `Toolkit`, `Items`, `Turn`, `Transcriber`, `SpeechSynthesizer`, `EmbeddingModel`, `Reranker`, `Chunker`, `Tokenizer`, `MusicGenerator`, `WebSearch`, `WebRead`, `Browser`, `Sandbox`, `DeepResearch`. No provider deps. |
...
├── recipes/                   # 37 worked recipes (type-checked, tested) covering
