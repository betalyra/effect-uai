...
- c3fbf04: Fix `OpenAIRealtimeTranscriber` for the GA Realtime wire and move off the deprecated transcription models.
...
- @effect-uai/responses@0.16.0

## 0.15.0

### Patch Changes

- @effect-uai/responses@0.15.0
...
- Updated dependencies [a7e3bc6]
  - @effect-uai/responses@0.14.0

## 0.13.0

### Patch Changes

- @effect-uai/responses@0.13.0

## 0.12.1

### Patch Changes

- @effect-uai/responses@0.12.1
...
- Updated dependencies [a739370]
- Updated dependencies [bd55235]
  - @effect-uai/responses@0.12.0
