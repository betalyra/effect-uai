...
| `@effect-uai/core/Inbox`                | `drainBurst(queue, settle)`: block for the first item, then keep taking while the next lands within `settle`; the window resets per arrival. The input side of a long-lived loop (agentic-loop and messenger-agent recipes).                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                              |
