...
| `@effect-uai/core/Retry`                | `Retry.stream(schedule)`, `Retry.effect(schedule)`, `Retry.Retryable`, `Retry.isRetryable` — retry the retryable subset of `AiError` (RateLimited \| Unavailable \| Timeout); works for any model service.                                                                                          |
...
| `@effect-uai/core/Loop`                 | `loop`, `loopWithState`, `nextAfter`, `emitValues`, `emitNext`, `stop`, `stopWith`, `stopAfter`, `stopWithAfter`, `onTurnComplete`.                                                                                                                                                                 |
...
| `@effect-uai/core/Toolkit`              | `Toolkit.make`, `Toolkit.executeAll`, `Toolkit.continueWith`, `Toolkit.collectResults`, `Toolkit.appendToolResults`.                                                                                                                                                                                |
