...
incremental TTS, multi-speaker dialogue), `RealtimeSession` (one duplex
speech-to-speech socket), `MusicGenerator`,
...
| Voice assistant: one duplex session, model-native barge-in           | `realtime-voice-agent`                                             |
